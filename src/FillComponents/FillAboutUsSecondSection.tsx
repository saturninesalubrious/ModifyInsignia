...
Get to know the values and principles that define how we work, innovate, and grow together. These are the cornerstones that guide every decision we make.
 ...
 lg:flex  lg:justify-center lg:items-center lg:content-center  lg:gap-[55px] lg:self-stretch lg:flex-wrap
 md:flex  md:justify-center md:items-center md:content-center  md:gap-[80px] md:self-stretch md:flex-wrap
 sm:flex  sm:justify-center sm:items-center sm:content-center  sm:gap-[40px] sm:self-stretch sm:flex-wrap
">
 ...
 sm:flex sm:w-[260px] sm:p-[20px] sm:flex-col sm:items-start sm:gap-[10px] sm:bg-[#F3F4F2] sm:rounded-[14px]
 ">
...
{/* bottom div */}
 ...
 sm:flex sm:w-full sm:p-[20px] sm:flex-col sm:items-start sm:gap-[10px] sm:bg-[#F3F4F2] sm:rounded-[14px]
 ">
