export default function OurAgileHeroSection () {
 return (
  <>
  ...
  sm:px-[40px] sm:py-[65px]
    ...
    md:p-[65px]
    2xl:px-[100px]  bg-cover bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/dpxtrzlia/image/upload/v1754296175/u1379145944_Minimalist_background_a_dark_blue_and_purple_grad_9b4422fa-d55a-4ec3-9350-1ae13ac85f80_0_1_raju2y.png')]
   ">
    {/* content holding div */}
    <div className="
...
Reinventing the Velocity Core of the Modern Enterprise
 ...
 ">
 Our Agile Transformation and DevOps capability exists to unlock latent organizational potential, empower high-velocity teams
 </p>
 ...
 ">
  ...
  {/* left heading holding div */}
     ...
     ">
      <img
       src="https://res.cloudinary.com/dpxtrzlia/image/upload/v1754297576/Frame_1000005109_1_aiqlsx.png"
