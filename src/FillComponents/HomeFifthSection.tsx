...
sm:flex sm:flex-col sm:justify-center sm:items-start sm:gap-[75px] sm:flex-[1_0_0]
">
...
{/* top div Main heading holder + dot div */}
...
<div className="
2xl:flex 2xl:items-center 2xl:gap-[20px] 2xl:self-stretch
xl:flex xl:items-center xl:content-center xl:gap-[20px] xl:self-stretch xl:flex-wrap
lg:flex lg:items-center lg:content-center lg:gap-[20px] lg:self-stretch lg:flex-wrap
md:flex md:items-center md:content-center md:gap-[20px] md:self-stretch md:flex-wrap
sm:flex sm:items-center sm:content-center sm:gap-[20px] sm:self-stretch sm:flex-wrap
">
