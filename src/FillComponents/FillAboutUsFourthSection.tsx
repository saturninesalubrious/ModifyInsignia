export default function FillAboutUsFourthSection () {
...
">
From bold beginnings to impactful partnerships
</h1>
...
">
  <img 
    src="https://res.cloudinary.com/dpxtrzlia/image/upload/v1753727960/Frame_1000005023_efefn4.png" 
    alt="Descriptive Alt" 
    className="
    w-full h-full object-cover rounded-[24px]
    md:w-full md:h-full md:object-object-fill md:rounded-[24px]
