...
{/* top most div */}
 ...
 <div className="
 2xl:flex 2xl:items-start 2xl:content-start 2xl:gap-[68px] 2xl:self-stretch 
 xl:flex xl:items-start xl:content-start xl:gap-[80px] xl:self-stretch 
 lg:flex  lg:justify-center lg:items-center lg:content-center  lg:gap-[104px] lg:self-stretch 
 md:flex  md:justify-center md:items-center md:content-center  md:gap-[88px] md:self-stretch 
 sm:flex  sm:justify-center sm:items-center sm:content-center  sm:gap-[60px] sm:self-stretch 
">
...
{/* information holding div */}
  ...
  {/* image holding div */}
<div className="
2xl:flex 2xl:items-center 2xl:gap-[10px] 2xl:flex-[1_0_0] 2xl:self-stretch 2xl:rounded-[24px] 2xl:bg-center
xl:flex xl:items-center xl:gap-[10px] xl:flex-[1_0_0] xl:self-stretch xl:rounded-[24px] xl:bg-center
lg:flex lg:h-[590px] lg:items-center lg:gap-[10px] lg:self-stretch lg:rounded-[24px]   lg:bg-center
">
  <img 
