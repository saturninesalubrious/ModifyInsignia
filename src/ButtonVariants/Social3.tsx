...
// A reusable button component that navigates to the LinkedIn page.
...
export default function YoutubeNavigationalButton() {
  return (
    <Link
      href="https://www.linkedin.com/company/insignia-consultancy-solutions/?viewAsMember=true" // Replace with your actual URL
      className="
