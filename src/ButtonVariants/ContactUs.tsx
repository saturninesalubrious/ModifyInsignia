...
export default function NavbarContactUsButton() {
  ...
  return (
   ...
   md:hidden md:items-center md:justify-center md:gap-[10px] md:px-[24px] md:py-[16px] md:rounded-[12px] md:bg-white md:text-[#1D1D1D] md:text-center md:text-[15px] md:leading-[16px] md:tracking-[0.45px] md:font-[550] md:font-sans
